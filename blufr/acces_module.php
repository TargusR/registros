...
/*-----------------------
	.blu framework
	Nombre componente: Modulo Control Acceso
	Version: 1.0x
-----------------------*/
...
function destroy_session($session = false){
	...
	unset($_SESSION['blu_acceso'], $_SESSION['blu_allowed_views']);
	
	return false;
}

function get_allowed_views($acceso) {
	// Crear Arreglo de Bitacoras
	switch($acceso) {
		case 'disenio':
		case 'gerencia':
		case 'all':
			// Listado de todas las bitacoras
			$acceso = "cotejados;impresos;separados;revision;cerrado;recoleccion;compras;cuentas";
		break;
		
		case 'atencion':
			$acceso = "cotejados;compras";
		break;
		
		case 'compras':
			$acceso = "separados;compras;";
		break;
		...
		case 'almacen_sup':
			$acceso = "separados;revision;cerrado;compras";
		break;
		
		case 'conciliacion':
			$acceso = "impresos;cotejados";
		break;
		...
		case 'anexo':
			$acceso = "cotejados;impresos;separados;revision;cerrado";
		break;
	}
	// devuelve arreglo definido
	return explode(';', $acceso);
}
